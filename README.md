...
## Autenticación con JWT y Keycloak
 ...
 Si no se envía el token o este no es válido, la API responde con el código `401 Unauthorized`. La comunicación con Keycloak se realiza dentro de la red de Docker mediante la dirección interna del servicio y el realm `user-realm`
